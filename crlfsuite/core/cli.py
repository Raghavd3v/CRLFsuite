...
request_grp.add_argument('--user-agent', help='Specify User-Agent (Example: Mozilla/5.0 (X11; Linux i586; rv:63.0) Gecko/20100101 Firefox/63.0).', default=get_user_agent())
request_grp.add_argument('--timeout', help='Connection timeout, default is 15', default=15)
